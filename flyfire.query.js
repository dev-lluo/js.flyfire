;(function(w,d,ff,s){
    ...
    var query = ff.query = function(selector){
        return new query.dm.init(s(selector));
    }.asCtor("Flyfire.Query");
    query.dm = query.prototype;
    query.dm.init = function(doms){
        this.doms = doms;
    };
    query.dm.init.prototype = query.dm;
    query.dm.each = function(func){
        each(this.doms,func);
        return this;
    };
    var eventHook = {
        input : OI8Select("input","propertychange")
    };
    var on = query.on = OI8Select(function(dom,type,func,useCapture){
    ...
    query.dm.on = function(type,func,useCapture){
        this.each(function(){
    ...
    var setVal = query.setVal = function(dom,val){
        dom.value = val;
    };
    var getVal = query.getVal = function(dom){
        return dom.value;
    };
    query.dm.val = function(val){
        if(arguments.length===1){
            each(this.doms,function(){
                setVal(this,val);
            });
    ...
    var setAttr = query.setAttr = function(dom,attr,val){
    ...
    query.dm.attr = function(attr,val){
    ...
    var getParent = query.getParent = function(dom){
        return dom.parentNode;
    };

    query.dm.parent = function(){
        var parent = new query.dm.init([]);
        each(this.doms,function(){
            parent.push(getParent(this));
        });
        return parent;
    };
    var append = query.append = function(parent,child){
        parent.appendChild(child);
    };
    query.dm.append = function(dom){
        each(this.doms,function(){
            append(this,dom);
        });
    };
    var remove = query.remove = function(child){
        child.parentNode.removeChild(child);
    };
    query.dm.remove = function(){
        each(this.doms,function(){
            remove(this);
        });
    };
    var replace = query.repalce = function(oldDom,newDom){
        oldDom.parentNode.replaceChild(newDom,oldDom);
    };
    query.dm.replace = function(dom){
        each(this.doms,function(){
            replace(this,dom);
        });
    };
